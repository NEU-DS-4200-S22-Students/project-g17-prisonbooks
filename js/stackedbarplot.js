...
svg5.append("text").attr("x", 20).attr("y", 355).text("True").style("font-size", "15px").attr("alignment-baseline","middle")
svg5.append("text").attr("x", 20).attr("y", 385).text("False").style("font-size", "15px").attr("alignment-baseline","middle")
